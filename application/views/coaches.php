    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $(".checkbox").click(function(){
          ...
          $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/add_coach')?>",
  ...
  <!--   =========-->
    <div class="container">
      <div class="row">
          ...
          <div class="panel panel-default">
            <div class="panel-body">
              <div class="panel-header">
                <h1>Coaches</h1>
                <p>Select the COACHES from the given list of persons</p>
              </div>
                                ...
                                <div class='row'>
                                  <div class='col-lg-9'>
                                    <div class='input-group'>
                                      ...
                                      <input type='text' class='form-control coach-input' placeholder='Experience'>
                                    </div>
                                  </div>
                                </div>
                              </td>";
        ...
        <center><a href="<?php echo site_url('admin/umpires')?>" class="btn btn-primary">Next &raquo;</a></center>
      </div>
    </div>
